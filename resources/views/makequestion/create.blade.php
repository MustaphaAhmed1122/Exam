...
<form method="post" action="{{route('makequestion.store')}}" enctype="multipart/form-data">
@csrf
		<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
		  ...
		  <div class="form-group">
		    <label  type="hidden" class="col-form-label" for="formGroupExampleInput2">Quiz ID</label>
		    <input type="hidden" name="quiz_id" class="form-control" id="formGroupExampleInput2"
