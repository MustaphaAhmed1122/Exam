...
<form method="post" action="{{ route('examinfo.store') }}" enctype="multipart/form-data">
	@csrf
	...
	<div class="col-md-6 col-lg-6 col-sm-6 col-lg-offset-3">
	  <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="Teacher_name" class="form-control " id="formGroupExampleInput" placeholder="example:someone111" required>
        </div>
	  <div class="form-group">
